    ...
    <el-row :gutter="0" type="flex" justify="space-between" style="margin: 10px 0;">
      ...
      <el-col :span="20">
        <el-button-group style="margin-right: 10px;">
          <el-button type="primary" @click="dialog_add=true">+ 添加奖励记录</el-button>
        </el-button-group>
    ...
    :total="rows.count">
        ...
        <el-dialog title="新增" :visible.sync="dialog_add" append-to-body width="380px">
          <el-form :model="info" label-width="80px">
            ...
            <el-form-item label="发生金额"> <el-input-number v-model="info.money" :precision="0" :step="10" :max="999999999"></el-input-number> </el-form-item>
    ...
    export default {
      ...
      methods: {
        ReLoad(){
          ...
          this.axios.post("/customer/admin_api/list_award_log", this.list_input).then((res) => {
        ...
        Save(){
          this.loading = true;
          this.axios.post("/customer/admin_api/add_award", {customer_id: this.customer_id, info: this.info}).then((res) => {
              this.loading = false;
