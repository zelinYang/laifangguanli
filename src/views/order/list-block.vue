<template>
  <div style="width: 99%;">
    ...
    <el-row :gutter="0" type="flex" justify="space-between" style="margin: 10px 0;">
      ...
      <!-- 搜索框 -->
      <el-col :span="4">
        <el-input placeholder="请输入要搜索的姓名" class="input-with-select" prefix-icon="el-icon-search" auto-complete="true" v-model="sousuo" @change="searchName(sousuo)" style="max-width: 280px; float: right;" :clearable="true"></el-input>
      </el-col>
    </el-row>
